...
| **Section 8.6: Kurtosis Reduction (Real)** | Real 48 layers: $\bar{\kappa}_0 = 61.42 \to \bar{\kappa}_1 = 1.61$ (Combined: $78.60 \to 0.12$) | `benchmarks/eval_kurtosis_sensitivity.py` | `benchmarks/kurtosis_sensitivity_results.json` | Local CPU / Pretrained GPT-2 | ✅ Verified |
| **Section 8.4: Real QLoRA vs M-2LRF (Harness)**| Step-0 Loss: $3.27$ vs $7.26$ (PPL: $26.27$ vs $1,261.42$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/m2lrf_vs_real_qlora_results.json` | Local CPU / Pretrained GPT-2 | ✅ Verified |
| **Section 8.4: Ablation 1A (LoftQ $K=2$)** | Step-0: $7.555$, Val PPL: **$1,259.12$** ($-0.18\%$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_loftq_iter2.json` | Local CPU / Pretrained GPT-2 | ✅ Verified |
| **Section 8.4: Ablation 1B (LoftQ $K=3$)** | Step-0: $7.186$, Val PPL: **$1,584.00$** (+322.58 drift) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_loftq_iter3.json` | Local CPU / Pretrained GPT-2 | ⚠️ Negative (Drift) |
| **Section 8.4: Ablation 2 (FWHT $B=64$)** | Step-0: $6.730$, Val PPL: **$742.92$** ($-41.1\%$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_fwht_hadamard.json` | Local CPU / Pretrained GPT-2 | 🏆 Verified Win |
| **Section 8.4: Ablation 3A (Rank $r=32$)** | Step-0: $7.114$, Val PPL: **$1,249.32$** ($-0.96\%$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_rank32.json` | Local CPU / Pretrained GPT-2 | ✅ Verified |
| **Section 8.4: Ablation 3B (Rank $r=64$)** | Step-0: $6.745$, Val PPL: **$668.91$** ($-47.0\%$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_rank64.json` | Local CPU / Pretrained GPT-2 | 🏆 Verified Win |
| **Section 8.4: Ablation 4 (Mixed 2.6 bpp)** | Step-0: $6.277$, Val PPL: **$525.17$** ($-58.4\%$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_mixed_26bpp.json` | Local CPU / Pretrained GPT-2 | 🏆 Verified Win |
| **Section 8.4: Combo (FWHT + Rank 64)** | Step-0: $5.729$, Val PPL: **$\mathbf{430.24}$** ($-65.9\%$) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_fwht_plus_rank64.json` | Local CPU / Pretrained GPT-2 | 👑 Champion 2-Bit |
| **Section 8.4: Combo (Mixed + Rank 64)** | Step-0: $5.625$, Val PPL: $5,002.89$ (Unstable w/o FWHT) | `benchmarks/m2lrf_vs_real_qlora_harness.py` | `benchmarks/ablation_mixed_26bpp_rank64.json` | Local CPU / Pretrained GPT-2 | ⚠️ Unstable w/o FWHT |
