"""
M-2LRF Native 2-Bit Architecture: GPTNeoX
...
class GPTNeoXAttention(nn.Module):
    def __init__(self, config: GPTNeoXConfig):
        ...
        self.rotary_emb = GPTNeoXRotaryEmbedding(self.head_dim, base=config.rope_theta)
...
class GPTNeoXModel(nn.Module):
    def __init__(self, config: GPTNeoXConfig):
        ...
        self.layers = nn.ModuleList([GPTNeoXDecoderLayer(config) for _ in range(config.num_hidden_layers)])
