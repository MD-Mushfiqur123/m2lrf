"""
M-2LRF Native 2-Bit Architecture: Granite
...
class GraniteAttention(nn.Module):
    def __init__(self, config: GraniteConfig):
        ...
        self.rotary_emb = GraniteRotaryEmbedding(self.head_dim, base=config.rope_theta)
...
class GraniteModel(nn.Module):
    def __init__(self, config: GraniteConfig):
        ...
        self.layers = nn.ModuleList([GraniteDecoderLayer(config) for _ in range(config.num_hidden_layers)])
