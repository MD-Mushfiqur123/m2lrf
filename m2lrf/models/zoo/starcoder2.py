"""
M-2LRF Native 2-Bit Architecture: StarCoder2
...
class StarCoder2Attention(nn.Module):
    def __init__(self, config: StarCoder2Config):
        ...
        self.rotary_emb = StarCoder2RotaryEmbedding(self.head_dim, base=config.rope_theta)
...
class StarCoder2Model(nn.Module):
    def __init__(self, config: StarCoder2Config):
        ...
        self.layers = nn.ModuleList([StarCoder2DecoderLayer(config) for _ in range(config.num_hidden_layers)])
