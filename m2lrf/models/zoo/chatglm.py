"""
M-2LRF Native 2-Bit Architecture: ChatGLM
...
class ChatGLMAttention(nn.Module):
    def __init__(self, config: ChatGLMConfig):
        ...
        self.rotary_emb = ChatGLMRotaryEmbedding(self.head_dim, base=config.rope_theta)
...
class ChatGLMDecoderLayer(nn.Module):
    def __init__(self, config: ChatGLMConfig):
        super().__init__()
        self.self_attn = ChatGLMAttention(config)
