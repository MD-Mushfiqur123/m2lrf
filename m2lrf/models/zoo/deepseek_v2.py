"""
M-2LRF Native 2-Bit Architecture: DeepSeekV2
...
class DeepSeekV2Attention(nn.Module):
    def __init__(self, config: DeepSeekV2Config):
        ...
        self.rotary_emb = DeepSeekV2RotaryEmbedding(self.head_dim, base=config.rope_theta)
...
class DeepSeekV2Model(nn.Module):
    def __init__(self, config: DeepSeekV2Config):
        ...
        self.layers = nn.ModuleList([DeepSeekV2DecoderLayer(config) for _ in range(config.num_hidden_layers)])
