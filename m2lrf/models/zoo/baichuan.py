"""
M-2LRF Native 2-Bit Architecture: Baichuan
...
class BaichuanRotaryEmbedding(nn.Module):
...
class BaichuanAttention(nn.Module):
    def __init__(self, config: BaichuanConfig):
        ...
        self.rotary_emb = BaichuanRotaryEmbedding(self.head_dim, base=config.rope_theta)
